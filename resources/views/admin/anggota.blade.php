        ...
        <table id="datatable" class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href='#' class='on-default edit-row btn btn-primary' data-toggle="modal" data-target="#edit-modal" onclick="setEditForm('{{ $data->idAnggota }}', '{{ $data->NIMAnggota }}', '{{ $data->namaAnggota }}', '{{ App::make('Controller')->jabatan($data->jabatanAnggota); }}', '{{ $data->programStudiAnggota }}')"><i class='fa fa-pencil'></i></a>
