                ...
                <div class="card-body">
                    <form action="{{ secure_url('/register') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nama" name="nama" onchange="setProgramStudi()" class="form-control">
                            @if ($errors->has('nama'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="programStudi" name="programStudi" class="form-control" readonly>
